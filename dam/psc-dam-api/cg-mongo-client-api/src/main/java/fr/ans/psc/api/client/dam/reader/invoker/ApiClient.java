package fr.ans.psc.api.client.dam.reader.invoker;
...
import fr.ans.psc.api.client.dam.reader.invoker.auth.Authentication;
import fr.ans.psc.api.client.dam.reader.invoker.auth.HttpBasicAuth;
import fr.ans.psc.api.client.dam.reader.invoker.auth.ApiKeyAuth;
import fr.ans.psc.api.client.dam.reader.invoker.auth.OAuth;

@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2022-03-01T10:44:01.736Z[GMT]")@Component("fr.ans.psc.api.client.dam.reader.invoker.ApiClient")
public class ApiClient {
    ...
    private String basePath = "http://psc-dam-reader-api";
